 ...
 * @version $Revision: 1.8 $ $Date: 2005/05/22 06:47:24 $
...
public class NestedRuntimeException extends RuntimeException {
     ...
     */
    public NestedRuntimeException(final String message) {
        super(message);
    }
     ...
     * @param cause the exception that caused this one.
     */
    public NestedRuntimeException(final String message, final Throwable cause) {
        super(message);
        this.cause = cause;
    }
